...
module.exports = {
  async up(queryInterface, Sequelize) {
    await queryInterface.createTable('sii_egresos', {
      id: {
        allowNull: false,
        autoIncrement: true,
        primaryKey: true,
    ...
    // Crear índices
    await queryInterface.addIndex('sii_egresos', ['tipo_dte', 'folio']);
    await queryInterface.addIndex('sii_egresos', ['proveedor_rut']);
    await queryInterface.addIndex('sii_egresos', ['receptor_rut']);
    await queryInterface.addIndex('sii_egresos', ['fecha_emision']);
    await queryInterface.addIndex('sii_egresos', ['estado_sii']);
    await queryInterface.addIndex('sii_egresos', ['proyecto_id']);
  },

  async down(queryInterface, Sequelize) {
    await queryInterface.dropTable('sii_egresos');
  }
};
