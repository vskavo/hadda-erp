// Script para probar el servicio de scraping y ver qué está devolviendo
const fetch = require('node-fetch');

async function testScrapingService() {
  try {
    console.log('🧪 Probando servicio de scraping de ingresos...');

    const response = await fetch('https://scraper-sii-773544359782.southamerica-west1.run.app/scrape-sii', {
      method: 'POST',
      headers: {
