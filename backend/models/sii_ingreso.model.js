...
module.exports = (sequelize) => {
  const SiiIngreso = sequelize.define('SiiIngreso', {
    id: {
  ...
  SiiIngreso.associate = (models) => {
    SiiIngreso.belongsTo(models.Proyecto, {
